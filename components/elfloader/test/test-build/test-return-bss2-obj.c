...
#include "unity.h"
#include "loader.h"
#include "../payload-build/test-return-bss2-obj.h"
...
TEST_CASE("test-return-bss2", "[esp32-elfloader]") {

    ELFLoaderContext_t* ctx = elfLoaderInitLoadAndRelocate(payload_build_test_return_bss2_elf, &env);
    if (ctx == NULL) {
