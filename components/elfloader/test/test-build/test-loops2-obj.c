...
#include "unity.h"
#include "loader.h"
#include "../payload-build/test-loops2-obj.h"
...
TEST_CASE("test-loops2", "[esp32-elfloader]") {

    ELFLoaderContext_t* ctx = elfLoaderInitLoadAndRelocate(payload_build_test_loops2_elf, &env);
    if (ctx == NULL) {
