...
#include "unity.h"
#include "loader.h"
#include "../payload-build/test-return-rwdata-volatile-obj.h"
...
TEST_CASE("test-return-rwdata-volatile", "[esp32-elfloader]") {

    ELFLoaderContext_t* ctx = elfLoaderInitLoadAndRelocate(payload_build_test_return_rwdata_volatile_elf, &env);
    if (ctx == NULL) {
