...
#include "unity.h"
#include "loader.h"
#include "../payload-build/test-nop-obj.h"
...
TEST_CASE("test-nop", "[esp32-elfloader]") {

    ELFLoaderContext_t* ctx = elfLoaderInitLoadAndRelocate(payload_build_test_nop_elf, &env);
    if (ctx == NULL) {
