...
#include "unity.h"
#include "loader.h"
#include "../payload-build/test-return-bss-obj.h"
...
TEST_CASE("test-return-bss", "[esp32-elfloader]") {

    ELFLoaderContext_t* ctx = elfLoaderInitLoadAndRelocate(payload_build_test_return_bss_elf, &env);
    if (ctx == NULL) {
