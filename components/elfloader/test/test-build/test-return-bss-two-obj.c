...
#include "unity.h"
#include "loader.h"
#include "../payload-build/test-return-bss-two-obj.h"
...
TEST_CASE("test-return-bss-two", "[esp32-elfloader]") {

    ELFLoaderContext_t* ctx = elfLoaderInitLoadAndRelocate(payload_build_test_return_bss_two_elf, &env);
    if (ctx == NULL) {
