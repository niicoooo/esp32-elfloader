...
#include "unity.h"
#include "loader.h"
#include "../payload-build/test-return-bss-extern-obj.h"
...
TEST_CASE("test-return-bss-extern", "[esp32-elfloader]") {

    ELFLoaderContext_t* ctx = elfLoaderInitLoadAndRelocate(payload_build_test_return_bss_extern_elf, &env);
    if (ctx == NULL) {
