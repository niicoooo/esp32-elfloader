...
#include "unity.h"
#include "loader.h"
#include "../payload-build/test-return-rwdata-extern-obj.h"
...
TEST_CASE("test-return-rwdata-extern", "[esp32-elfloader]") {

    ELFLoaderContext_t* ctx = elfLoaderInitLoadAndRelocate(payload_build_test_return_rwdata_extern_elf, &env);
    if (ctx == NULL) {
