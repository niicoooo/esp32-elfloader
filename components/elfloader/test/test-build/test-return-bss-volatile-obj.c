...
#include "unity.h"
#include "loader.h"
#include "../payload-build/test-return-bss-volatile-obj.h"
...
TEST_CASE("test-return-bss-volatile", "[esp32-elfloader]") {

    ELFLoaderContext_t* ctx = elfLoaderInitLoadAndRelocate(payload_build_test_return_bss_volatile_elf, &env);
    if (ctx == NULL) {
